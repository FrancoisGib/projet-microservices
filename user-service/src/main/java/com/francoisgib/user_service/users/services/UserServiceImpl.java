...
import com.francoisgib.user_service.users.UserRepository;
...
public class UserServiceImpl implements UserService {
	...
	@Override
	public User getByEmail(String email) throws UserResourceException {
	...
	@Override
	public User getByUsername(String username) throws UserResourceException {
	...
	public User createUser(UserCreationForm userCreationForm) {
		...
		return userRepository.save(User.builder()
			...
			.organizationId(userCreationForm.getOrganizationId())
	...
	public User updateUser(Long id, UserUpdateForm userUpdateForm) throws UserResourceException {
		...
		if (userUpdateForm.getOrganizationId() != null && !user.getOrganizationId().equals(userUpdateForm.getOrganizationId())) {
			user.setOrganizationId(userUpdateForm.getOrganizationId());
			update = true;
		}
		if (update) {
